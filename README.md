...
3. Replace `your_api_key_here` in `src/api.js` with your OMDB API key. You can get one from [OMDB API](https://www.omdbapi.com/apikey.aspx).
...
1. Search for movies, series, or episodes using the search bar.
2. Filter the results by type using the dropdown.
3. Click on any movie to view detailed information.
4. Add movies to your favorites and view them on the favorites page.
...
- Add more filters like release year and genre.
